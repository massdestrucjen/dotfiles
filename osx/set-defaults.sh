...
sudo scutil --set ComputerName "Retinater"
sudo scutil --set HostName "Retinater"
sudo scutil --set LocalHostName "Retinater"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Retinater"
